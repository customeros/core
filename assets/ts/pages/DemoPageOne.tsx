...
export const DemoPageOne = ({ place, facts }: Fact) => {
  const loadFacts = () => {
    ...
    <>
      <div className="rounded-md shadow flex items-center gap-x-6 bg-gray-900 px-6 py-2.5 sm:px-3.5 mb-8">
        <p className="text-sm leading-6 text-white">
          <Link href="/groceries">
            <span>
              A <strong className="font-semibold">more advanced demo</strong> can be found here!
            </span>
          </Link>
        </p>
      </div>
      <div className="px-4 sm:px-0">
        <div className="md:flex md:items-center md:justify-between">
          ...
          <div className="mt-4 flex md:ml-4 md:mt-0">
            <Button variant="solid" colorScheme="primary" onClick={navigateToGroceries}>
              Bulangereala
            </Button>
          </div>
        </div>
