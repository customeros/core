  ...
  return (
    <RootLayout>
      ...
      {companies.length === 0 ? (
        ...
        <div className=" h-[calc(100vh-3rem)] overflow-x-hidden relative bg-white p-0 transition-[width] duration-300 ease-in-out w-full 2xl:w-[1440px] 2xl:mx-auto animate-fadeIn">
