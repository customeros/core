...
export const Welcome = () => {
  ...
  return (
    <div className="h-screen w-screen flex flex-col items-center justify-start px-4 bg-white relative overflow-hidden animate-fadeIn ">
      <div className="relative w-full flex justify-center">
        <div className="bg-[url('/images/half-circle-pattern.svg')] bg-cover bg-center bg-no-repeat w-[700px] h-[700px] -mt-[100px]" />
      </div>

      <div className="flex flex-col items-center -mt-[264px]">
              ...
              return (
                ...
                >
                  <div className="bg-white rounded-xl shadow-lg p-6 text-center border border-gray-200 flex flex-col items-center gap-4">
                    ...
                    <h2 className="text-base font-semibold text-primary-600 mb-2">{slide.title}</h2>
