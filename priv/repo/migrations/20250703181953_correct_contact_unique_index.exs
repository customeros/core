defmodule Core.Repo.Migrations.CorrectContactUniqueIndex do
  ...
  def up do
    ...
    create unique_index(:contacts, [:linkedin_id, :linkedin_company_id],
             name: :contacts_linkedin_id_company_id_index
           )
  end

  def down do
    # Drop the composite unique index
    drop_if_exists index(:contacts, [:linkedin_id, :linkedin_company_id],
                     name: :contacts_linkedin_id_company_id_index
                   )
