defmodule Core.Integrations.Connections do
  ...
  ## Examples
      ...
      # Update last sync
      {:ok, connection} = update_last_sync(connection, :success)
  """
  ...
  @doc """
  Updates the last sync information for a connection.

  ## Examples

      iex> update_last_sync(connection, :success)
      {:ok, %Connection{}}

      iex> update_last_sync(connection, :error, "Sync failed")
      {:ok, %Connection{}}
  """
  def update_last_sync(%Connection{} = connection, :success) do
  ...
  def update_last_sync(%Connection{} = connection, :error, error_message) do
    update_connection(connection, %{
      last_sync_at: DateTime.utc_now(),
